...
type Module = typeof import("../app.campaigns.$id.edit_.tiered.js")

type Info = GetInfo<{
  file: "routes/app.campaigns.$id.edit_.tiered.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.campaigns.$id.edit_.tiered.js");
}];
