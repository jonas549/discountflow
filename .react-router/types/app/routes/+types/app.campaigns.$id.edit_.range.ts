...
type Module = typeof import("../app.campaigns.$id.edit_.range.js")

type Info = GetInfo<{
  file: "routes/app.campaigns.$id.edit_.range.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.campaigns.$id.edit_.range.js");
}];
