...
type Module = typeof import("../app.campaigns.$id.edit_.bxgy.js")

type Info = GetInfo<{
  file: "routes/app.campaigns.$id.edit_.bxgy.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.campaigns.$id.edit_.bxgy.js");
}];
