...
type Module = typeof import("../app.campaigns.$id.edit_.cart-value.js")

type Info = GetInfo<{
  file: "routes/app.campaigns.$id.edit_.cart-value.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.campaigns.$id.edit_.cart-value.js");
}];
