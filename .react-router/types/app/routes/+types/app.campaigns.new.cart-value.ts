...
type Module = typeof import("../app.campaigns.new.cart-value.js")

type Info = GetInfo<{
  file: "routes/app.campaigns.new.cart-value.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.campaigns.new.cart-value.js");
}];
