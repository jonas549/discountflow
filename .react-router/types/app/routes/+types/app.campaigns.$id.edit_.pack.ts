...
type Module = typeof import("../app.campaigns.$id.edit_.pack.js")

type Info = GetInfo<{
  file: "routes/app.campaigns.$id.edit_.pack.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.campaigns.$id.edit_.pack.js");
}];
