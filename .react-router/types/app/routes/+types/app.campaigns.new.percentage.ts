...
type Module = typeof import("../app.campaigns.new.percentage.js")

type Info = GetInfo<{
  file: "routes/app.campaigns.new.percentage.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.campaigns.new.percentage.js");
}];
