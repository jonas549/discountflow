...
type Module = typeof import("../api.internal.pause-over-limit.js")

type Info = GetInfo<{
  file: "routes/api.internal.pause-over-limit.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.internal.pause-over-limit.js");
}];
